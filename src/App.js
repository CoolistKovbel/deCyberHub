    ...
    <div className="App">
      ...
      <Routes>
        <Route path="/" element={<Layout />}>
          <Route index element={<Home currentAccount={currentAccount} setCurrentAccount={setCurrentAccount} connectWallet={connectWallet} createAccount={createAccount} currentAmountOfAccounts={currentAmountOfAccount} />} />
          <Route path="account" element={<Account account={currentAccount} />} />
